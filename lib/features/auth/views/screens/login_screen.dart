...
class SignInScreen extends ConsumerStatefulWidget {
  ...
  ConsumerState<SignInScreen> createState() =>
      _SignInScreenState(); // Creates the state for this screen.
}
...
class _SignInScreenState extends ConsumerState<SignInScreen> {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            backgroundColor:
                darkColor, // Set background color for the snack bar.
            content: Text(
              'Failed to sign in', // Error message content.
              style: GoogleFonts.nunito(
                  color: Colors.white), // Custom font style for the message.
            ),
          ),
        );
      } finally {
        ...
        setState(() {
          _isLoading =
              false; // Set loading state to false after sign-in process.
        });
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final buttonWidth =
        isWeb ? 400.0 : double.infinity; // Set button width based on platform.
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    width: isWeb
                        ? 400
                        : double.infinity, // Set width for text field.
                  ...
                  SizedBox(
                    width: isWeb
                        ? 400
                        : double.infinity, // Set width for password text field.
                    child: QuranQuestTextField(
                      controller:
                  ...
                  _isLoading
                      ? CircularProgressIndicator(
                          color:
                              darkColor, // Show loading indicator if signing in.
                        )
                      : SizedBox(
                  ...
                  Center(
                    child: TextButton(
                      onPressed: () {
                        AppRouter.router
                            .go(RouteTo.signUp); // Navigate to sign-up screen.
                      },
                      child: Text(
